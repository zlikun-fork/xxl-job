...
<@netCommon.commonScript />
    ...
    <#elseif jobInfo.glueType == "GLUE_PHP" >
        <#assign glueTypeModeSrc = "${request.contextPath}/plugins/codemirror/mode/php/php.js" />
        <#assign glueTypeIdeMode = "text/x-php" />
        <#assign glueTypeModeSrc02 = "${request.contextPath}/plugins/codemirror/mode/clike/clike.js" />
    ...
    <#elseif jobInfo.glueType == "GLUE_POWERSHELL" >
        <#assign glueTypeModeSrc = "${request.contextPath}/plugins/codemirror/mode/powershell/powershell.js" />
